    ...
    "features": {
        1: [
            ...
            },
            {
                ...
                "description": "You have learned to cast spells through your bardic arts. The following informations detail how you use the Spellcasting Widget present in this character sheet with Bard spells. \n *Cantrips.* You know two cantrips of your choice from the Bard spell list, visible when clicking the Manage button in the Spellcasting Widget. Whenever you gain a Bard level, you can replace one of your cantrips with another cantrip of your choice from the Bard spell list. When you reach Bard levels 4 and 10, you learn another cantrip of your choice from the Bard spell list, as the Spellcasting Widget will update accordingly. \n *Spell Slots.* The Spellcasting Widget shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a Long Rest. \n *Prepared Spells of Level 1+.* You prepare the list of level 1+ spells that are available for you to cast with this feature in the Spellcasting Widget. To start, click the Manage button in the Spellcasting Widget and choose four level 1 spells from the spell list provided. The number of spells on your list increases as you gain Bard levels, as the Spellcasting Widget will update accordingly. Whenever that number increases, choose additional spells from the Bard spell list until the number of spells on your list matches the number shown in the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you available to use. If another Bard feature gives you spells that you always have prepared, those spells don't count against the number of spells you can prepare with this feature, but those spells otherwise count as Bard spells for you. \n *Changing Your Prepared Spells.* Whenever you gain a Bard level, you can replace one spell on your list with another Bard spell on the Manage UI of the Spellcasting Widget. \n *Spellcasting Ability.* Charisma is your spellcasting ability for your Bard spells. More informations shown in the Spellcasting Widget. \n *Spellcasting Focus.* You can use a Musical Instrument as a Spellcasting Focus for your Bard spells.",
                "details": {
                    "Action": "Passive",
                    "recharge": "Long Rest"
                }
        ...
        2: [
            {
                ...
                "description": "You gain Expertise in two of your skill proficiencies of your choice. Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.",
                "details": {
                    "Action": "Passive",
                    "choice": {
                        "choose": 2,
        ...
        1: [
            {
                ...
                "description": "You have learned to cast spells through prayer and meditation. The following informations detail how you use the Spellcasting Widget present in this character sheet with Cleric spells. \n *Cantrip.* You know three cantrips of your choice from the Cleric spell list, visible when clicking the Manage button in the Spellcasting Widget. Whenever you gain a Cleric level, you can replace one of your cantrips with another cantrip of your choice from the Cleric spell list. When you reach Cleric levels 4 and 10, you learn another cantrip of your choice from the Cleric spell list, as the Spellcasting Widget will update accordingly. \n *Spell Slots.* The Spellcasting Widget shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a Long Rest. \n *Prepared Spells of Level 1+.* You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, click the Manage button in the Spellcasting Widget and choose four level 1 spells from the spell list provided. The number of spells on your list increases as you gain Cleric levels, as the Spellcasting Widget will update accordingly. Whenever that number increases, choose additional spells from the Manage UI of the Spellcasting Widget until the number of spells on your list matches the number on the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you available to use. If another Cleric feature gives you spells that you always have prepared, those spells don't count against the number of spells you can prepare with this feature, but those spells otherwise count as Cleric spells for you. \n *Changing Your Prepared Spells.* Whenever you finish a Long Rest, you can change your list of prepared spells, replacing any of the spells there with other Cleric spells in the Manage UI of the Spellcasting Widget. \n *Spellcasting Ability.* Wisdom is your spellcasting ability for your Cleric spells. More informations present in the Spellcasting Widget. \n *Spellcasting Focus.* You can use a Holy Symbol as a Spellcasting Focus for your Cleric spells.",
                "details": {
                    "Action": "Passive",
                    "recharge": "Long Rest"
                }
        ...
        1: [
            {
                ...
                "description": "You have learned to cast spells through studying the mystical forces of nature. The following informations detail how you use the Spellcasting Widget present in this character sheet with your Druid spells. \n *Cantrips.* You know two cantrips of your choice from the Druid spell list, visible when clicking the Manage button in the Spellcasting Widget. Whenever you gain a Druid level, you can replace one of your cantrips with another cantrip of your choice from the Druid spell list. When you reach Druid levels 4 and 10, you learn another cantrip of your choice from the Druid spell list, as the Spellcasting Widget updates accordingly. \n *Spell Slots.* The Spellcasting Widget shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a Long Rest. \n *Prepared Spells of Level 1+.* You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, click the Manage button in the Spellcasting Widget and choose four level 1 spells from the spell list provided. The number of spells on your list increases as you gain Druid levels, as the Spellcasting Widget updates accordingly. Whenever that number increases, choose additional spells from the Manage UI of the Spellcasting Widget until the number of spells on your list matches the number on the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you avaiable to use. If another Druid feature gives you spells that you always have prepared, those spells don't count against the number of spells you can prepare with this feature, but those spells otherwise count as Druid spells for you. \n *Changing Your Prepared Spells.* Whenever you finish a Long Rest, you can change your list of prepared spells, replacing any of the spells with other Druid spells in the Manage UI of the Spellcasting Widget. \n *Spellcasting Ability.* Wisdom is your spellcasting ability for your Druid spells. \n *Spellcasting Focus.* You can use a Druidic Focus as a Spellcasting Focus for your Druid spells.",
                "details": {
                    "Action": "Passive",
                    "recharge": "Long Rest"
                }
    ...
    "features": {
        1: [
            ...
            },
            {
                ...
                "description": "You have learned to cast spells through prayer and meditation. The following informations detail how you use the Spellcasting Widget present in this character sheet with Paladin spells. \n *Spell Slots.* The Spellcasting Widget shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a Long Rest. \n *Prepared Spells of Level 1+.* You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, click the Manage button in the Spellcasting Widget and choose two level 1 Paladin spells. The number of spells on your list increases as you gain Paladin levels, as the Spellcasting Widget will update accordingly. Whenever that number increases, choose additional spells from Manage UI of the Spellcasting Widget until the number of spells on your list matches the number on the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you available use. If another Paladin feature gives you spells that you always have prepared, these spells don't count against the number of spells you can prepare with this feature, but those spells otherwise count as Paladin spells for you. \n *Changing Your Prepared Spells.* Whenever you finish a Long Rest, you can replace one spell on your list with another Paladin spell in the Manage UI of the Spellcasting Widget. \n *Spellcasting Ability.* Charisma is your spellcasting ability for your Paladin spells. More informations present in the Spellcasting Widget. \n *Spellcasting Focus.* You can use a Holy Symbol as a Spellcasting Focus for your Paladin spells.",
                "details": {
                    "Action": "Passive",
                    "recharge": "Long Rest"
                }
        ...
        1: [
            {
                ...
                "description": "You have learned to channel the magical essence of nature to cast spells. The following informations detail how you use the Spellcasting Widget present in this character sheet with Ranger spells. \n *Spell Slots*. The Spellcasting Widget shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a Long Rest. \n *Prepared Spells of Level 1+.* You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, click the Manage button in the Spellcasting Widget and choose two level 1 Ranger spells. The number of spells on your list increases as you gain Ranger levels, as the Spellcasting Widget updates accordingly. Whenever that number increases, choose addition spells from the Manage UI of the Spellcasting Widget until the number of spells on your list matches the number in the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you available to use. If another Ranger feature gives you spells that you always have prepared, those spells don't count against the number of spells you can prepare with this feature, but those spells otherwise count as Ranger spells for you. \n *Changing Your Prepared Spells.* Whenever you finish a Long Rest, you can replace one spell on your list with another Ranger spell in the Manage UI of the Spellcasting Widget. \n *Spellcasting Ability.* Wisdom is your spellcasting ability for your Ranger spells. More information in the Spellcasting Widget. \n *Spellcasting Focus.* You can use a Druidic Focus as a Spellcasting Focus for your Ranger spells.",
                "details": {
                    "Action": "Passive",
                    "spells_lvl_1": 2,
                    "recharge": "Long Rest"
        ...
        1: [
            {
                ...
                "description": "Drawing from your innate magic, you can cast spells. The following informations detail how you use the Spellcasting Widget present in this character sheet with Sorcerer spells. \n *Cantrip.* You know four cantrips of your choice from the Sorcerer spell list, visible when clicking the Manage button in the Spellcasting Widget. Whenever you gain a Sorcerer level, you can replace one of your cantrips from this feature with another Sorcerer cantrip of your choice. When you reach Sorcerer levels 4 and 10, you learn another another Sorcerer cantrip of your choice, as the Spellcasting Widget updates accordingly. \n *Spell Slots.* The Spellcasting Widget shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a Long Rest. \n *Prepared Spells of Level 1+.* You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, click the Manage button in the Spellcasting Widget and choose two level 1 Sorcerer spells. The number of spells on your list increases as you gain Sorcerer levels, as the Spellcasting Widget updates accordingly. Whenever that number increases, choose additional spells from the Manage UI of the Spellcasting Widget until the number of spells on your list matches the number in the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you available to use. If another Sorcerer feature gives you spells that you always have prepared, those spells don't count against the number of spells you can prepare with this feature, but those spells otherwise count as Sorcerer spells for you. \n *Changing Your Prepared Spells.* Whenever you gain a Sorcerer level, you can replace one spell on your list with another Sorcerer spell on the list in the Manage UI of the Spellcasting Widget. \n *Spellcasting Ability.* Charisma is your spellcasting ability for your Sorcerer spells. More informations present in the Spellcasting Widget. \n *Spellcasting Focus.* You can use an Arcane Focus as a Spellcasting Focus for your Sorcerer spells.",
                "details": {
                    "Action": "Passive",
                    "recharge": "Long Rest"
                }
    ...
    "features": {
        1: [
            ...
            },
            {
                ...
                "description": "Through occult ceremony, you have formed a pact with a mysterious entity to gain magical powers. The entity is a voice in the shadows, its identity unclear, but its boon to you is concrete: the ability to cast spells. The following informations detail how you use the Spellcasting Widget present in this character sheet wih Warlock spells. \n *Cantrips.* You know two cantrips of your choice from the Warlock spell list, visible when clicking the Manage button in the Spellcasting Widget. Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice. When you reach Warlock levels 4 and 10, you learn another Warlock cantrip of your choice, as the Spellcasting Widget updates accordingly. \n *Spell Slots.* The Spellcasting Widget shows how many spell slots you have to cast your Warlock spells of levels 1-5. The Spellcasting Widget also shows the level of those slots, all of which are the same level. You regain all expended Pact Magic spell slots when you finish a Short or Long Rest. \n *Prepared Spells of Level 1+.* You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, click on the Manage button in the Spellcasting Widget and choose two level 1 Warlock spells. The number of spells on your list increases as you gain Warlock levels, as the Spellcasting Widget updates accordingly. Whenever that number increases, choose additional spells from the Manage UI of the Spellcasting Widget until the number of spells on your list matches the number in the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you available to use. If another Warlock feature gives you spells that you always have prepared, those spells don't count against the number of spells you can prepare with this feature, but those spells otherwise count as Warlock spells for you. \n *Changing Your Prepared Spells.* Whenever you gain a Warlock level, you can replace one spell on your list with another Warlock spell of an eligible level. \n *Spellcasting Ability.* Charisma is the spellcasting ability for your Warlock spells. \n *Spellcasting Focus.* You can use an Arcana Focus as a Spellcasting Focus for your Warlock spells.",
                "details": {
                    "Action": "Passive",
                    "recharge": "Short or Long Rest"
                }
        ...
        1: [
            {
                ...
                "description": "As a student of arcane magic, you have learned to cast spells. The following informations detail how you use the Spellcasting Widget present in this character sheet with Wizard spells. \n *Cantrips.* You know three cantrips of your choice from the Wizard spell list, visible when clicking the Manage button in the Spellcasting Widget. Whenever you finish a Long Rest, you can replace one of your cantrips from this feature with another Wizard cantrip of your choice. When you reach Wizard levels 4 and 10, you learn another Wizard cantrip of your choice, as the Spellcasting Widget updates accordingly. \n *Spellbook.* Your wizardly apprenticeship culminated in the creation of a unique book: your spellbook. It is a Tiny object that weighs 3 pounds, contains 100 pages, and can be read only by you or someone casting Identify. You determine the book's appearance and materials, such as a gilt-edged tome or a collection of vellum bound with twine. The book contains the level 1+ spells you know. It starts with six level 1 Wizard spells of your choice, that can be chosen by clicking the Manage button in the Spellcasting Widget. Whenever you gain a Wizard level after 1, add two Wizard spells of your choice to your spellbook from the Manage UI of the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you available to use. The spells are the culmination of arcane research you do regularly. \n *Spell Slots.* The Spellcasting Widget shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a Long Rest. \n *Prepared Spells of Level 1+.* You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, click the Manage button in the Spellcasting Widget and choose four spells from your spellbook. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you availabe to use. The number of spells on your list increases as you gain Wizard spells, as the Spellcsating Widget updates accordingly. Whenever that number increases, choose addition spells from the Manage UI of the Spellcasting Widget until the number of spells on your listt matches the number in the table. If another Wizaard feature gives you spells that you always have prepared, those spells don't count against the number of spells you can prepare with this feature, but those spells otherwise count as Wizard spells for you. \n *Changing Your Prepared Spells.* Whenever you finish a Long Rest, you can change your list of prepared spells, replacing any of the spells there with spells from your spellbook. \n *Spellcasting Ability.* Intelligence is your spellcasting ability for your Wizard spells. \n *Spellcasting Focus.* You can use an Arcane Focus or your spellbook as a Spellcasting Focus for your Wizard spells.",
                "details": {
                    "Action": "Passive",
                    "recharge": "Long Rest"
                }
