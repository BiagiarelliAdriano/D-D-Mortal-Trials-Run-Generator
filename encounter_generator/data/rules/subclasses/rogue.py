            ...
            3: [
                {
                    ...
                    "description": "You have learned to cast spells. \n *Cantrips.* You know three cantrips: Mage Hand and two other cantrips of your choice from the Wizard spell list. Whenever you gain a Rogue level, you can replace one of your cantrips, except Mage Hand, with another Wizard cantrip of your choice. When you reach Rogue level 10, you learn another Wizard cantrip of your choice. \n *Spell Slots.* The Spellcasting Widget that should now be present within your Character Sheet shows how many spell slots you have to cast your level 1+ spells. You regain all expended spell slots when you finish a Long Rest. \n *Prepared Spells of 1st+ Level.* You prepare the list of level 1+ spells that are available for you to cast with this feature. To start, click the Manage button in the Spellcasting Widget and choose three level 1 Wizard spells. The number of spells on your list increases as you gain Rogue levels, as the Spellcasting Widget updates accordingly. Whenever that number increases, choose additional Wizard spells until the number of spells on your list matches the number in the Spellcasting Widget. The spells shown in the Manage UI of the Spellcasting Widget reflect the level of spell slots to you available to use. \n *Changing Your Prepared Spells.* Whenever you gain a Rogue level, you can replace one spell on your list with another Wizard spell for which you have spell slots. \n *Spellcasting Ability.* Intelligence is your spellcasting ability for your Wizard spells. \n *Spellcasting Focus.* You can use an Arcane Focus as a Spellcasting Focus for your Wizard spells.",
                    "details": {
